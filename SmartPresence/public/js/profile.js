...
if (cls.isTeacher) {
  ...
  // For students, pass class info as URL parameters (preserve DB department key)
  const deptParam = encodeURIComponent(cls.department);
  linkUrl = `classes-student.html?classId=${cls.classId}&teacherId=${cls.teacherId}&dept=${deptParam}`;
}
